...
int main(){
    ...
    Log mLog("Flight Data Log MAINTEST 29", "Program Data Log MAINTEST 29", mVN, startTime);
    
    mLog.write("Date: 8/17");
    mLog.write("Flight Name: MAIN TEST (29)\n");
    ...
    mLog.write("Entering main loop, shake to stop");
    float accelArray [numDataPointsChecked4Launch] = {0};
    float accelAvg = 0;
    int counter = 0;
    moveServoPair(servoPinE,servoPinW, 0);
